package com.tlmtech.pesquisamercado.enums;
...
public enum Instrucao {
	...
	FUNDAMENTAL_II_COMPLETO_MEDIO_INCOMPLETO(3, "Fundamental_II_completo / Médio incompleto"), 
	MEDIO_COMPLETO_SUPERIOR_INCOMPLETO(4, "Médio completo / Superior incompleto"), 
